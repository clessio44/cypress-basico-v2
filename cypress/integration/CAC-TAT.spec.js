...
describe("Central de Atendimento ao Cliente TAT", function(){
    ...
    it("exibe mensagem de erro ao submeter o formulário com um email com formatação inválida", function(){
       cy.clock();
        ...
        cy.get("#firstName").type("Clessio");
        cy.get("#lastName").type("Silva");
        cy.get("#email").type("clessiosilva44sgmail.com");
        cy.get("#open-text-area").type("Teste");
        cy.contains("button", "Enviar").click();
       
        cy.get(".error").should("be.visible");
        cy.tick(THREE_SECONDS_IN_MS);
        cy.get(".error").should("not.be.value");
    })
    ...
    it("preenche e limpa os campos nome, sobrenome, email e telefone", function(){
        cy.get("#firstName").type("Clessio").should("have.value", "Clessio");
        cy.get("#lastName").type("Silva").should("have.value", "Silva");
        cy.get("#email").type("clessiosilva44@gmail.com").should("have.value", "clessiosilva44@gmail.com");
